    ...
    <section className="relative min-h-[88vh] flex items-center overflow-hidden bg-[var(--color-charcoal)]">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 py-20 w-full">
        <div className="max-w-2xl animate-fade-up">
          <p className="text-[var(--color-brass)] text-xs md:text-sm font-medium tracking-[0.3em] uppercase mb-6">כיורי שיש איטלקי בעבודת יד</p>
          ...
          <p className="text-[var(--color-cream)]/85 text-lg md:text-xl leading-relaxed max-w-xl">כל כיור הוא יצירה בודדת. שיש איטלקי מובחר, חיתוך מדויק, גימור ידני. תצוגה מקדימה של הכיור שלכם — לפני שחתכנו אבן אחת.</p>
        </div>
      </div>
    </section>
  );
