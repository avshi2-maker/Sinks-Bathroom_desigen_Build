...
const pillars = [
  ...
  },
  {
    ...
    text: "כל כיור נחתך לפי המידות, הזוויות והפרופורציות שאתם מגדירים. שלחו שרטוט, קובץ או מידות גולמיות, ואלס ורוסלן בונים בהתאמה מושלמת לחלל שתכננתם.",
  },
  {
    badge: "03",
...
const steps = [
  ...
  },
  {
    num: "4",
    title: "אנחנו בונים",
    text: "אלס ורוסלן חותכים, מלטשים ומרכיבים ידנית. תוך 14 יום הכיור מותקן בפרויקט.",
  },
];
        ...
        <section className={sectionLight}>
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="space-y-5 text-[var(--color-charcoal)]/75 text-lg leading-relaxed">
              ...
              <p>אלס ורוסלן, אומני החיתוך והבנייה שלנו, חותכים ומלטשים כל כיור ביד בסדנה בישראל. אנחנו עובדים מול חומרים מובחרים — שיש איטלקי (Calacatta, Statuario, Saint Laurent), גרניט פורצלן ואריחים מדוקקים — כל לוח נבחר ידנית ומגיע עם תיעוד מלא.</p>
